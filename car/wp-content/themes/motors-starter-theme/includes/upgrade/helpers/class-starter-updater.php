	...
	public static function get_install_themes_list() {
		return array(
			array(
				...
				'name' => __( 'Motors Skins', 'starter-text-domain' ),
				'type' => 'theme',
				'src'  => 'https://stylemixthemes-public.s3.us-west-2.amazonaws.com/motors-starter-theme-' . StarterUpdateCheck::starter_server_version() . '.zip', // phpcs:ignore
			),
		);
	}
